...
const Trademark = () => {
  ...
  const { haveTrademark, trademarkName, issuedBy, scope } = trademark;
  console.log(trademark);
  const onChange = (event) => {
    setTrademark({ [event.target.name]: event.target.value });
  };
      ...
      <Grid item container xs={12}>
        ...
        <Paper className={classes.paper}>
          <Grid container spacing={2}>
            <Grid item xs={3}>
              <Typography variant='p'>Do you have a trademark?</Typography>
            </Grid>
            <Grid item xs={9}>
              <form>
                <Grid item container spacing={2}>
                  ...
                  <Grid item container spacing={2} xs={12}>
                    ...
                    <Grid item xs={6}>
                      <p>
                        Upload and image of your <br></br> trademark
                      </p>
                      <PurpleButton
                        variant='contained'
                        color='secondary'
